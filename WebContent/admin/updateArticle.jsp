		...
		<div class="container" id="main">
			...
			<form action="${pageContext.request.contextPath}/updateArticle" method="post">
				...
				<div class="info">
					...
					<input class="form-control" name="time" value="2018-08-13 08:52:54" type="text"> -->
					<!-- author-->
					<!-- sort -->
					<span class="help">分类</span><br>
					<c:forEach items="${sorts}" var="sort">
						<input class="btn btn-default" value="${sort.sortName}" onclick="sort_click(this)" type="button"> &nbsp;
					</c:forEach>
					<input class="form-control" id="sort" name="sort" type="text" value="${article.sort }">
					<!-- tag -->
					<%-- <span class="help">标签</span><br>
					<c:forEach items="${tags}" var="tag">
						<input class="btn btn-default" value="${tag.tag.tag}" onclick="tags_click(this)" type="button">&nbsp;
					</c:forEach>
				...
				<div class="editormd editormd-vertical" id="mdView" style="width: 90%; height: 720px;" data-old-width="1204" data-old-height="720">
					<textarea name="content" class="editormd-markdown-textarea" placeholder="Enjoy Markdown! coding now..." style="display: none;">${article.content }</textarea>
				...
				<br>
				<input class="btn btn-default" value="更新" type="submit">
			</form>
		...
		<script type="text/javascript">
			...
			$(function() {
				testEditor = editormd("mdView", {
					...
					imageUploadURL: "/MyBlog/uploadPic",
					//后台只需要返回一个 JSON 数据				      
					onload: function() {
